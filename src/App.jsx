...
export default function App() {
  ...
  const [isHovering, setIsHovering] = useState(false);
   const fullText = 'created prompts';
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      if (direction === 1) {
        ...
        setContainerWidth(next.length * 8 + 12);
        index++;
        ...
        const next = fullText.slice(0, index - 1);
        setDisplayedText(next);
        setContainerWidth(Math.max(next.length * 8 + 12, 1));
        index--;
  ...
  return (
                  ...
                  <div className="flex flex-col lg:grid lg:grid-cols-[262px_1fr_262px] gap-6 justify-items-center">
                    ...
                    <div className="relative order-1 lg:order-2 flex flex-col items-center gap-6 w-full max-w-[550px] mx-auto px-2">
                      ...
                      <motion.img
                        src={sphere}
                        alt="sphere"
                        // className="absolute sphere top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 object-contain  z-30"
                        className={`absolute sphere top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 object-contain z-30 pointer-events-auto ${isHovering ? "fast-spin" : "slow-spin"
                          }`}
                        initial={
                    ...
                    {/* LEFT COLUMN */}
                    <div className="order-2 mt-6 lg:mt-0 lg:order-1 flex flex-col gap-6 w-full min-w-[262px]">
                      <motion.div
                        initial={
                          flag ? {
                    ...
                    <div className="order-3 lg:order-3 flex flex-col gap-6 w-full min-w-[262px]">
                      ...
                      <div className="bgdiv h-[412px] w-full rounded-xl px-4 py-6 relative" onClick={handleOpenPage3}>
                        ...
                        {/* Trial Tag */}
                        <div className="rotate-[-20deg] w-fit ml-20 mt-6">
                          <span
    ...
    `,
                        ...
                        <div className="rotate-[-54deg] w-fit ml-5 mt-10">
                          <span
                        ...
                        {/* Buttons Grid */}
                        <div className="rotate-[30deg] w-fit ml-[90px]">
                          <span
                            className="inline-flex border border-[#fff]/33 rounded-full items-center justify-center text-xs text-white p-3"
                            style={{
                              backgroundImage: `
      ...
      `,
                          ...
                          >
                            <FaGift className="text-[#ffffff]/90 w-7 h-7" />
                          </span>
                        </div>
                        <div className="rotate-[38deg] w-fit ml-15 mt-1">
                          <span
                        ...
                        <div className="rotate-[-90deg] w-fit px-6 py-2 rounded-full border border-white/15 bg-[#2D2E58] flex items-center space-x-6 absolute left-[39%] bottom-[29%]" style={{ backdropFilter: 'blur(6px)' }}>
                          {/* JPG */}
                        ...
                        {/* Buttons Grid */}
                        <div className="rotate-[50deg] w-fit ml-0 -mt-15">
                          <span
                            className="bglayer inline-flex border border-[#fff]/33 rounded-full items-center justify-center text-xs text-white p-3 rounded-full"
                            style={{
                              backgroundImage: `
      ...
      `,
                          ...
                          >
                            <IoIosCamera className='text-[#ffffff]/90 w-7 h-7' />
                          </span>
